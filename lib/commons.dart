...
class CommonData {
  static final String appTitle = 'Vac-Seen';
  static final String appVer = '1.0';
  static final String appDesc =
      'An Open-Source App that can track COVID-19 Vaccines in India. Supports Notifications and traffic at the vaccine centre. Retrieves data directly from the CoWIN Public APIs. You still have to go through CoWIN website in order to book the vaccine slot.';
